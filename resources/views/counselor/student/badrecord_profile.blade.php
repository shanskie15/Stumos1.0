          ...
          <table class="table" id="studentTable">
            ...
            <tbody>
                  <tr>
                    ...
                    <td>
                    <button class="btn btn-sm btn-primary" onclick="viewDesc({{$student->id}})" data-target="#bigModal" data-toggle="modal"><i class="fas fa-address-card"></i>View</button>
                    </td>
                  </tr>
                  @endforeach   
            </tbody>
...
@section('js')
@include('inc.counselor.badrecords')
@endsection